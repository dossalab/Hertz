...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'opengl.data';
    var REMOTE_PACKAGE_BASE = 'opengl.data';
...
Module['FS_createPath']('/', 'res', true, true);
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_opengl.data');

    };
    Module['addRunDependency']('datafile_opengl.data');
 ...
 loadPackage({"files": [{"filename": "/shaders/simple.vert", "start": 0, "end": 371, "audio": 0}, {"filename": "/shaders/simple.frag", "start": 371, "end": 829, "audio": 0}, {"filename": "/res/ship.stl", "start": 829, "end": 1816413, "audio": 0}, {"filename": "/res/test.jpg", "start": 1816413, "end": 1860447, "audio": 0}, {"filename": "/res/skybox.stl", "start": 1860447, "end": 1861131, "audio": 0}], "remote_package_size": 1861131, "package_uuid": "bb78fc4b-7bf6-4cb9-9d9f-ac4047966b05"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 11536,
    DYNAMIC_BASE = 5254416,
    DYNAMICTOP_PTR = 11376;
...
var wasmBinaryFile = 'opengl.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__lock": ___lock, "__syscall221": ___syscall221, "__syscall3": ___syscall3, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__unlock": ___unlock, "abort": _abort, "abs": _abs, "emscripten_force_exit": _emscripten_force_exit, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_main_loop": _emscripten_set_main_loop, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "glAttachShader": _glAttachShader, "glBindBuffer": _glBindBuffer, "glBindTexture": _glBindTexture, "glBindVertexArray": _glBindVertexArray, "glBufferData": _glBufferData, "glClear": _glClear, "glCompileShader": _glCompileShader, "glCreateProgram": _glCreateProgram, "glCreateShader": _glCreateShader, "glDeleteShader": _glDeleteShader, "glDepthFunc": _glDepthFunc, "glDrawArrays": _glDrawArrays, "glEnable": _glEnable, "glEnableVertexAttribArray": _glEnableVertexAttribArray, "glGenBuffers": _glGenBuffers, "glGenTextures": _glGenTextures, "glGenVertexArrays": _glGenVertexArrays, "glGenerateMipmap": _glGenerateMipmap, "glGetAttribLocation": _glGetAttribLocation, "glGetShaderInfoLog": _glGetShaderInfoLog, "glGetShaderiv": _glGetShaderiv, "glGetUniformLocation": _glGetUniformLocation, "glLinkProgram": _glLinkProgram, "glShaderSource": _glShaderSource, "glTexImage2D": _glTexImage2D, "glTexParameteri": _glTexParameteri, "glUniformMatrix4fv": _glUniformMatrix4fv, "glUseProgram": _glUseProgram, "glVertexAttribPointer": _glVertexAttribPointer, "glViewport": _glViewport, "glfwCreateWindow": _glfwCreateWindow, "glfwGetWindowSize": _glfwGetWindowSize, "glfwInit": _glfwInit, "glfwMakeContextCurrent": _glfwMakeContextCurrent, "glfwPollEvents": _glfwPollEvents, "glfwSetCursorPosCallback": _glfwSetCursorPosCallback, "glfwSetErrorCallback": _glfwSetErrorCallback, "glfwSetFramebufferSizeCallback": _glfwSetFramebufferSizeCallback, "glfwSetKeyCallback": _glfwSetKeyCallback, "glfwSwapBuffers": _glfwSwapBuffers, "glfwWindowHint": _glfwWindowHint, "glfwWindowShouldClose": _glfwWindowShouldClose, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
